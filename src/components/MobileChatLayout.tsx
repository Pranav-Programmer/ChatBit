    ...
    <div className='fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        <Link
          href='/dashboard'
          >
          <Image src={logo} alt='Logo' style={{height:'2rem', width:'2.5rem'}}/>
        </Link>
        {/* <Button style={{width:'2rem', height:'2rem'}} onClick={() => setOpen(true)} className='gap-4'> */}
          <Menu onClick={() => setOpen(true)} className='h-auto w-auto' />
        {/* </Button> */}
      </div>
              ...
              <div className='pointer-events-none fixed inset-y-0 left-0 flex max-w-full pr-10'>
                <Transition.Child
                  ...
                  <Dialog.Panel className='pointer-events-auto w-screen max-w-md'>
                    <div className='flex h-full flex-col overflow-hidden bg-white py-6 shadow-xl bg-teal-50'>
                      <div className='px-4 sm:px-6'>
                        <div className='flex items-start justify-between'>
                          <div className='flex flex-row ...'>
                            <Image src={logo} alt='Logo' style={{height:'2rem', width:'2.5rem'}}/>
                            <Dialog.Title className='font-semibold leading-6 text-gray-900 mt-1 font-bold text-2xl'>
                              ChatBit
                            </Dialog.Title>
                          </div>
                      ...
                      <div className='relative mt-6 flex-1 px-4 sm:px-6'>
                        ...
                        <nav className='flex flex-1 flex-col'>
                          ...
                          <div className='text-xs font-semibold leading-6 text-gray-400 -mb-6'>
                            ...
                            <li className='-ml-6 mt-auto flex items-center bottom-0 fixed w-100%'>
